...
- **Package detail** `src/app/packages/[id]/page.tsx` (`/packages/[id]`) — BUILT. Same design (Figma 141:3109) — REUSES `DestinationDetail` (props `ctaHref`/`ctaLabel`; package page passes `/checkout` + "Reserve Now"; destinations reuse defaults to "Explore Packages" → /packages).
